...
export function NextVideoToast({ isOpen }: INextVideoToastProps) {
  ...
  return (
    <Toast.Provider swipeDirection="right">
      <Toast.Root
        open={isOpen}
        className="data-[state=open]:animate-slideIn data-[state=closed]:animate-hide data-[swipe=end]:animate-swipeOut flex items-center justify-center gap-x-2 rounded-md bg-zinc-800 p-4
